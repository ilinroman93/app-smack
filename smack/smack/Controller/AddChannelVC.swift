...
class AddChannelVC: UIViewController {
    ...
    @IBAction func createChannelBtnPressed(_ sender: Any) {
        ...
        guard let channelDesccription = channelDesc.text, channelDesc.text != "" else { return }
        SocketService.instance.addChannel(channelName: channelName, channelDescription: channelDesccription) { (success) in
            if success {
